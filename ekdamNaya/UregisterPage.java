...
public class UregisterPage extends JFrame {
	...
	public UregisterPage() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\DELL\\Downloads\\Webp.net-compress-image (2).jpg"));
		label.setBounds(679, 11, 95, 65);
		panel.add(label);
		...
		JLabel lblExperienceTheThrill = new JLabel("Experience the  thrill of quiz");
		lblExperienceTheThrill.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblExperienceTheThrill.setBounds(29, 43, 210, 14);
		panel.add(lblExperienceTheThrill);
		...
		lblUsername.setBounds(29, 100, 63, 14);
